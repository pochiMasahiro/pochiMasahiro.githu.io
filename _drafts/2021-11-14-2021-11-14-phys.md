...
$$
\begin{equation}
\gamma a = \tan^{-1}\left(\frac{\sqrt{k_0^2\left(n_1^2-n_2^2\right) - \gamma^2}}{\gamma}\right) + \tan^{-1}\left(\frac{\sqrt{k_0^2\left(n_2^2-n_3^2\right)-\gamma^2}}{\gamma}\right) + m\pi
\end{equation}
$$
